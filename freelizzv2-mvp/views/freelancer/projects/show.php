...
<div class="card">
  <div class="muted">Cliente: <?= htmlspecialchars($project['client_name']) ?> • <?= htmlspecialchars($project['client_email']) ?></div>
...
<div class="grid">
  <div class="card col-7">
    ...
    <form method="post" action="/freelancer/projects/<?= (int)$project['id'] ?>/message" style="margin-top:10px;display:flex;gap:8px">
  ...
  <div class="card col-5">
    ...
    <form method="post" action="/freelancer/projects/<?= (int)$project['id'] ?>/review">
      <input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf) ?>">
    ...
    <form method="post" action="/freelancer/projects/<?= (int)$project['id'] ?>/dispute">
      <input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf) ?>">
    ...
    <a class="btn secondary" href="/freelancer/projects">Voltar</a>
  </div>
</div>
